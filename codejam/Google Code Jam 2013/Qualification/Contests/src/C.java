...
//            out.println(s);
    ...
    void createNumbers() {
        ...
        for(int i=0; i<cad0.length ;i++) {
            ...
            if(verifyIfFairAndSquare(x)) res2++;
        }
        ...
        ArrayList<String> cad2a1 = new ArrayList<String>();
        cad2a1.add("101");
        recurCad1a(cad2a1);// 0 and 1
        ArrayList<String> cad2a2 = new ArrayList<String>();
        cad2a2.add("111");
        recurCad1a(cad2a2);// 0 and 1
        ArrayList<String> cad2a3 = new ArrayList<String>();
        cad2a3.add("121");
        recurCad1a(cad2a3);// 0 and 1
